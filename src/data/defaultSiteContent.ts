...
export const DEFAULT_SITE_CONTENT: SiteContent = {
  ...
  hero: {
    ...
    previewLabel: 'La vida del barrio, en una sola aplicación',
    previewImageUrl: '/landing-media/hero-app-preview.svg',
    previewImageAlt: 'Mockup de la aplicación El Barrio con actividad, alertas y mercado local',
    backgroundVideoUrl: '/landing-media/hero-barrio.mp4',
    backgroundPosterUrl: '/landing-media/hero-barrio-poster.jpg',
  ...
  story: {
    visible: true,
    eyebrow: 'El corazón de El Barrio',
    titlePart1: 'Volver a sentir que',
    titleHighlight: 'vivimos en un barrio',
    paragraph1: 'Vivimos rodeados de personas cuyos nombres no conocemos. A pocos metros hay manos dispuestas a ayudar, conocimientos por compartir y soluciones que podrían hacernos la vida más simple, pero muchas veces no sabemos cómo encontrarnos.',
    paragraph2: 'El Barrio convierte esa cercanía en comunidad. No es una red para seguir desconocidos ni competir por atención, sino un espacio organizado por territorio, donde vecinos, familias, emprendedores, prestadores y comercios pueden participar en la vida cotidiana de su sector.',
    paragraph3: 'Porque un barrio no es solamente un conjunto de calles. Es una red de personas que pueden cuidarse, ayudarse y crear oportunidades cuando tienen una forma simple y confiable de conectarse.',
    closingText: 'El Barrio pone la tecnología al servicio de algo profundamente humano: volver a estar cerca.',
    mediaType: 'image',
    mediaUrl: '/landing-media/historia-barrio.webp',
    mediaPosterUrl: '/landing-media/historia-barrio.webp',
    mediaAlt: 'Pareja caminando junta por una calle de Santiago',
    mediaCaption: 'Santiago de Chile',
  },
  scene: {
