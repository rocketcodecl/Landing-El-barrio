...
export const DEFAULT_SITE_CONTENT: SiteContent = {
  ...
  hero: {
    ...
    previewLabel: 'El Barrio · Las Condes',
    previewImageUrl: '/landing-media/barrio-comunidad.jpg',
    previewImageAlt: 'Vecinos compartiendo en un entorno residencial de barrio',
